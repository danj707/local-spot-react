   ...
   if(element.venue.name) {
      if(element.venue.location.lat) {
         if(element.venue.location.lng) {
            ...
            let loc_img = element.venue.photos.groups[0].items[0].prefix ? element.venue.photos.groups[0].items[0].prefix + "width60" + element.venue.photos.groups[0].items[0].suffix  : 'No image';
            let loc_tips = element.tips[0].text ? element.tips[0].text : 'No Tips';
